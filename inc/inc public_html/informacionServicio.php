...
?>
  <form name="formServicio" method="post" action="inc/procesaInformacionServicio.php" enctype="application/x-www-form-urlencoded">
    ...
    <article class="form-group col-xs-6">
      <label>Precio $</label>
      <input maxlength="12" name="precio" type="text" required="" class="form-control input-sm" id="precio" placeholder="Ej: 200000" data-validation-required-message="Ingrese precio." value="<?php echo $datos['srvc_precio']; ?>" >
      <p class="help-block text-danger"></p>
    </article>
    <article class="form-group col-xs-6">
      <label>Descuento $</label>              
      <input maxlength="12" name="descuentoPrecio" type="text" required="" class="form-control input-sm" id="descuentoPrecio" placeholder="Ej: 300000" data-validation-required-message="Ingrese descuento del servicio." value="<?php echo $datos['srvc_descuentoPrecio']; ?>" >
      <p class="help-block text-danger"></p>
    </article>              
    <article class="form-group col-xs-6">
      <label>Dormitorios</label>              
      <input maxlength="4" name="dormitorios" type="text" required="" class="form-control input-sm" id="dormitorios" placeholder="Ej: 1, 2, etc." data-validation-required-message="Ingrese cantidad de dormitorios." value="<?php echo $datos['srvc_dormitorios']; ?>" >
      <p class="help-block text-danger"></p>
    </article>
    <article class="form-group col-xs-6">
      <label>Ba&ntilde;os</label>              
      <input maxlength="4" name="banos" type="text" required="" class="form-control input-sm" id="banos" placeholder="Ej: 1, 2, etc." data-validation-required-message="Ingrese cantidad de ba&ntilde;os." value="<?php echo $datos['srvc_banos']; ?>" >
      <p class="help-block text-danger"></p>
    </article>
    <article class="form-group col-xs-6">
      <label>Estacionamientos</label>              
      <input maxlength="3" name="estacionamientos" type="text" required="" class="form-control input-sm" id="estacionamientos" placeholder="Ej: 1, 2, etc." data-validation-required-message="Ingrese cantidad de estacionamientos." value="<?php echo $datos['srvc_estacionamientos']; ?>" >
      <p class="help-block text-danger"></p>
    </article>      
    <article class="form-group col-xs-6">
      <label>Superficie</label>              
      <input maxlength="10" name="superficie" type="text" required="" class="form-control input-sm" id="superficie" placeholder="Ej: 250" data-validation-required-message="Ingrese dimensi&oacute;n." value="<?php echo $datos['srvc_superficie']; ?>" >
      <p class="help-block text-danger"></p>
    </article>
    <article class="form-group col-xs-6">
