  ...
  <form name="formUsuario" method="post" action="inc/procesaInformacionUsuario.php" enctype="application/x-www-form-urlencoded">
          <div class="" id="contentIn">
              ...
              <label>Indique su ciudad</label>
                <input maxlength="40" name="ciudad" type="text" required="" class="form-control input-sm" id="ciudad" placeholder="Su Ciudad de origen *" data-validation-required-message="Ingrese su direcci&oacute;n." value="<?php echo $_SESSION['sesionCiudad']; ?>" >
                <p class="help-block text-danger"></p>
              </div>              
              <div class="form-group col-xs-6">
              <label>Indique su fecha de nacimiento</label>
                <input maxlength="20" name="nacimiento" type="text" required="" class="form-control input-sm" id="nacimiento" placeholder= "Ej: Año-Mes-Dia" data-validation-required-message="Ind&iacute;que su fecha de nacimiento." value="<?php echo $_SESSION['sesionNacimiento'];?>" />                 
                <p class="help-block text-danger"></p>
              </div>
              <div class="form-group col-xs-6">
